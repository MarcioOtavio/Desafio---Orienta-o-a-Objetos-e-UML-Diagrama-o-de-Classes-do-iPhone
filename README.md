# Desafio--Orientação-a-Objetos-e-UML-Diagrama-o-de-Classes-do-iPhone
![terraform](https://img.shields.io/badge/-UML-white?style=for-the-badge&logo=UML&color=FABD14&logoColor=white)
Este é um diagrama UML que representa a estrutura de classes e interfaces para um sistema que inclui a modelagem do iPhone, um dispositivo que incorpora funcionalidades de um reprodutor de música, um telefone e um navegador de internet. Este diagrama foi criado como parte do desafio de projeto do Santander Bootcamp 2024 - Backend com Java na DIO.
![desafio-poo-iphone](https://github.com/MarcioOtavio/Desafio---Orienta-o-a-Objetos-e-UML-Diagrama-o-de-Classes-do-iPhone/assets/114531896/4c55a118-e4aa-4044-8b29-e6149f845b3c)
